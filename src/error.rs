...
mod tests {
    ...
    fn test_fmt() {
        ...
        assert_eq!(
            format!(
                "{}",
                Error::make_error_msg("Test message for Message error".to_string())
            )
            .as_str(),
        ...
        assert_eq!(
            format!(
                "{}",
                Error::make_error_io(io::Error::new(io::ErrorKind::NotFound, "Test io error"))
            )
            .as_str(),
            "Test io error"
        );
        assert_eq!(
            format!("{}", Error::make_error_syntax(ErrorCode::InvalidDimension)).as_str(),
            "Invalid Dimension of vectors"
        );
        assert_eq!(
            format!(
                "{}",
                Error::make_error_syntax(ErrorCode::InvalidNumberOfArguments)
            )
            .as_str(),
        ...
        assert_eq!(
            format!(
                "{}",
                Error::make_error_syntax(ErrorCode::InvalidArgumentInput)
            )
            .as_str(),
            "Given argument is invalid"
        );
        assert_eq!(
            format!(
                "{}",
                Error::make_error_syntax(ErrorCode::FeatureNotProvided)
            )
            .as_str(),
            "Functionality is not provided yet"
        );
        assert_eq!(
            format!("{}", Error::make_error_syntax(ErrorCode::TooLargeTimeStep)).as_str(),
            "Time step is too large"
        );
    }
    ...
    fn test_classify() {
        ...
        assert_eq!(
            Error::make_error_msg("Test message".to_string()).classify(),
            Category::Data
        );
        assert_eq!(
            Error::make_error_io(io::Error::new(io::ErrorKind::NotFound, "Test io error"))
        ...
        assert_eq!(
            Error::make_error_syntax(ErrorCode::InvalidDimension).classify(),
            Category::Syntax
        );
        assert_eq!(
            Error::make_error_syntax(ErrorCode::InvalidNumberOfArguments).classify(),
            Category::Syntax
        );
        assert_eq!(
            Error::make_error_syntax(ErrorCode::TooLargeTimeStep).classify(),
            Category::Syntax
        );
        assert_eq!(
            Error::make_error_syntax(ErrorCode::FeatureNotProvided).classify(),
            Category::Syntax
        );
    }
}
